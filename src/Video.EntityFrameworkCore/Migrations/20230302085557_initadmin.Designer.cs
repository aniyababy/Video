...
namespace Video.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230302085557_initadmin")]
            ...
            modelBuilder.Entity("Video.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("18aaa639-68fd-4c91-8ece-21509c8999e1"),
                            Code = "admin1",
            ...
            modelBuilder.Entity("Video.Domain.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7ae36cec-70a7-46ef-b92a-356525babf4f"),
                            CreateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleId = new Guid("18aaa639-68fd-4c91-8ece-21509c8999e1"),
                            UserId = new Guid("646a26fa-7877-441c-b390-df81f50e5b6d")
                        });
                });
            ...
            modelBuilder.Entity("Video.Domain.Users.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("646a26fa-7877-441c-b390-df81f50e5b6d"),
                            Avatar = "",
                            CreateTime = new DateTime(2023, 3, 2, 16, 55, 57, 404, DateTimeKind.Local).AddTicks(9934),
                            Enable = true,
                            Name = "admin1",
                            Password = "admin1",
                            Username = "admin1"
